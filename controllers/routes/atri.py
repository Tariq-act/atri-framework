...
class Atri:
	def __init__(self, state: Any):
		...
		self.NavLink = state["NavLink"]
		self.book-btn = state["book-btn"]
		self.Image1 = state["Image1"]
		self.NavEl-1 = state["NavEl-1"]
		self.NavEl-2 = state["NavEl-2"]
		self.NavEl-3 = state["NavEl-3"]
		self.NavEl-4 = state["NavEl-4"]
		self.NavEl-5 = state["NavEl-5"]
	...
	@property
	def NavLink(self):
		self._getter_access_tracker["NavLink"] = {}
		return self._NavLink
	@NavLink.setter
	def NavLink(self, new_state):
		self._setter_access_tracker["NavLink"] = {}
		global default_state
		self._NavLink = Flex(new_state, default_state["NavLink"])

	@property
	def book-btn(self):
		self._getter_access_tracker["book-btn"] = {}
		return self._book-btn
	@book-btn.setter
	def book-btn(self, new_state):
		self._setter_access_tracker["book-btn"] = {}
		global default_state
		self._book-btn = Flex(new_state, default_state["book-btn"])
	...
	@property
	def NavEl-1(self):
		self._getter_access_tracker["NavEl-1"] = {}
		return self._NavEl-1
	@NavEl-1.setter
	def NavEl-1(self, new_state):
		self._setter_access_tracker["NavEl-1"] = {}
		global default_state
		self._NavEl-1 = TextBox(new_state, default_state["NavEl-1"])

	@property
	def NavEl-2(self):
		self._getter_access_tracker["NavEl-2"] = {}
		return self._NavEl-2
	@NavEl-2.setter
	def NavEl-2(self, new_state):
		self._setter_access_tracker["NavEl-2"] = {}
		global default_state
		self._NavEl-2 = TextBox(new_state, default_state["NavEl-2"])

	@property
	def NavEl-3(self):
		self._getter_access_tracker["NavEl-3"] = {}
		return self._NavEl-3
	@NavEl-3.setter
	def NavEl-3(self, new_state):
		self._setter_access_tracker["NavEl-3"] = {}
		global default_state
		self._NavEl-3 = TextBox(new_state, default_state["NavEl-3"])

	@property
	def NavEl-4(self):
		self._getter_access_tracker["NavEl-4"] = {}
		return self._NavEl-4
	@NavEl-4.setter
	def NavEl-4(self, new_state):
		self._setter_access_tracker["NavEl-4"] = {}
		global default_state
		self._NavEl-4 = TextBox(new_state, default_state["NavEl-4"])

	@property
	def NavEl-5(self):
		self._getter_access_tracker["NavEl-5"] = {}
		return self._NavEl-5
	@NavEl-5.setter
	def NavEl-5(self, new_state):
		self._setter_access_tracker["NavEl-5"] = {}
		global default_state
		self._NavEl-5 = TextBox(new_state, default_state["NavEl-5"])
	...
	def _to_json_fields(self):
		return {
			...
			"Div2": self._Div2,
			"Div3": self._Div3,
			"NavLink": self._NavLink,
			"book-btn": self._book-btn,
			"Image1": self._Image1,
			"NavEl-1": self._NavEl-1,
			"NavEl-2": self._NavEl-2,
			"NavEl-3": self._NavEl-3,
			"NavEl-4": self._NavEl-4,
			"NavEl-5": self._NavEl-5,
			"Image2": self._Image2,
			}
